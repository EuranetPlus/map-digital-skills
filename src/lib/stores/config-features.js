export const config = {
	mapTitle: 'map-europe-digital-skills', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'https://map-digital-skills.vercel.app/', // The url provided when deploying the map on Vercel
